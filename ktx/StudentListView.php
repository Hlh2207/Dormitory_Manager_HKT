    ...
    <div class="toolbar">
        <form method="GET" style="display:contents">
            <div class="search-box">
                <span>🔍</span>
                <input type="text" name="search" placeholder="Tìm theo tên, MSSV, email, SĐT..." value="<?= htmlspecialchars($search) ?>">
            </div>
            ...
            <table>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td class="hide-mobile"><span class="badge <?= $sv['gender'] === 'male' ? 'badge-male' : 'badge-female' ?>"><?= genderLabel($sv['gender']) ?></span></td>
                        ...
                        <td>
                            <div style="display:flex;gap:6px;flex-wrap:wrap">
                                <a href="StudentFormView.php?student_id=<?= $sv['student_id'] ?>" class="btn btn-edit btn-sm">✏ Sửa</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
