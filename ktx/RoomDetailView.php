...
.room-available { background: var(--c-avail-lt); border-color: var(--c-avail-bd); }
.room-full { background: var(--c-full-lt); border-color: var(--c-full-bd); }
.room-maint { background: var(--c-maint-lt); border-color: var(--c-maint-bd); }
.room-closed, .room-unknown { background: var(--c-closed-lt); border-color: var(--c-closed-bd); }

.room-number { font-size: 20px; font-weight: 800; line-height: 1; margin-bottom: 6px; }
...
.room-beds { display: flex; gap: 3px; flex-wrap: wrap; margin-bottom: 8px; }
.bed {
...
.room-status-badge { font-size: 11px; font-weight: 700; display: flex; align-items: center; gap: 3px; }
...
.room-price { font-size: 11px; color: var(--muted); margin-top: 5px; }
...
function showModal(data) {
    ...
    const rows = [
        ...
        ['Giá/tháng',     parseInt(data.price_per_month).toLocaleString('vi-VN') + ' VND'],
